...
class Habit(Base):
    ...
    last_completed: Mapped[str | None] = mapped_column(String(40), nullable=True)           #date/time(if hourly habit) the habbit was last completed
    completed_dates: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)  #list of dates/times the habit was completed. 
